...
class FunctionComponent(AppFunctionComponent):
    """Component that implements function 'gili_multi'"""
    ...
    def _app_function(self, fn_inputs):
        """
        Function: multiple 2 given numbers
        Inputs:
            -   fn_inputs.a
            -   fn_inputs.b
        """
        ...
        multiple = fn_inputs.a * fn_inputs.b
        yield self.status_message(f"multiple = {multiple}")
        ...
        yield FunctionResult(results)
        #yield FunctionResult(multiple, success=True, reason=None)
